  ...
  <div class="max-w-screen-md mx-auto flex flex-col justify-between" v-if="story">
    <ClientOnly>
      <transition name="fade">
        <CommonLoader v-if="pendingStory || pendingPosts || loading" />
      </transition>
    </ClientOnly>
    <div class="mb-5">
      <CommonPagination v-if="posts && posts.meta.current_page > 1" :offset="3" :pagination="posts.meta" @paginate="changePage" class="my-14 relative flex justify-center" />
    ...
    <CommonPagination v-if="posts" :offset="3" :pagination="posts.meta" @paginate="changePage" class="my-14 relative flex justify-center" />
  </div>
</template>
