<template>
  <div class="container mx-auto max-w-screen-md px-4 pt-40 pb-60">
    <div>
      ...
      <p class="md:text-2xl">
        ...
        <LayoutLazyImage width="736" height="414" class="rounded-md" src="/default.jpeg" :blur="true" alt="Johannes und Isabell bei den zwölf Aposteln" />
        ...
        Bali und Lombok hinter uns gelassen haben, werden wir unsere Zelte in Thailand aufschlagen und die Straßen Bangkoks unsicher machen. Zu Fuß, mit unserem Auto, auf dem Wasser und auch darunter
